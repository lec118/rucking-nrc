...
// 메인 컴포넌트
export default function SlimWorkout() {
  ...
  useEffect(() => {
    ...
    const tileKey = import.meta.env.VITE_MAP_TILE_KEY || 'HxwFT8f8xpxgtrrfgQMb';
  ...
  if (screen === 'setup') {
    return (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100vh', background: '#0F1613', color: '#E5ECE8', padding: '24px' }}>
        <h1 style={{ fontSize: '32px', fontWeight: 'bold', marginBottom: '32px' }}>러킹 추적기 (슬림)</h1>
